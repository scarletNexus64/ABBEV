        ...
        <div class="bg-dark-100 rounded-xl shadow-lg border border-dark-200 p-6">
            ...
            <div x-data="bunnyPicker('')" x-init="init()">
                ...
                <div x-show="!selected" class="mt-2 max-h-72 overflow-y-auto bg-dark-50 border border-dark-200 rounded-lg divide-y divide-dark-200">
                    ...
                    <template x-if="!loading && results.length === 0"><div class="p-4 text-gray-500 text-sm text-center">Aucune vidéo libre. Upload des vidéos sur <a href="https://dash.bunny.net/stream/{{ config('services.bunny.library_id') }}/library/overview" target="_blank" class="text-primary-300 underline">Bunny</a> d'abord.</div></template>
